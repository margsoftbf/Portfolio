...
const Hero = () => {
	return (
		...
		>
			<div className='absolute flex justify-center top-12 right-0 bottom-0 left-0 w-full h-full lg:justify-end lg:mt-8'>
				<HeroBgAnimation />
			</div>
